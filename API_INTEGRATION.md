# RoostFinder — API Integration Map

Brief mapping of **frontend components → backend endpoints**. Backend is an Express 5 API
(root, port `5000`); frontend is Next.js 15 (`frontend/`, port `3000`).
